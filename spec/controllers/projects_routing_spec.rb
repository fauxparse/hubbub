...
describe ProjectsController do
  describe "route generation" do
    it "should map #index" do
      route_for(:controller => "projects", :action => "index", :company_id => 1).should == "/companies/1/projects"
    end
  
    it "should map #new" do
      route_for(:controller => "projects", :action => "new", :company_id => 1).should == "/companies/1/projects/new"
    end
