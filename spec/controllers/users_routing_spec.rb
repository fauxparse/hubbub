...
describe UsersController do
  describe "route generation" do
    it "should map #index" do
      route_for(:controller => "users", :action => "index", :company_id => 1).should == "/companies/1/users"
    end
  
    it "should map #new" do
      route_for(:controller => "users", :action => "new", :company_id => 1).should == "/companies/1/users/new"
    end
